...
// Stack Modifying Definitions

#define stackdef typedef long long int
#define stack_d stackdef

_asm_struct_ stackcd_d {
  stack_t stackContents;
  stackc_t stackBits;
} stackcd_t;

_asm_struct_ modified_stack_d {
  stackcd_t *stackOne;
  stackcd_t *stackTwo;
  stackcd_t *stackThree; //Throw SIGUNSUP if used
} modified_stack_t modified_stack;
...
_sasm_ move(stackc_t *from_stack, stackc_t to_stack)
{
